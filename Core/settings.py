...
SECRET_KEY = 'django-insecure-29r1u%%d#ha5-43=&xzs-9fsdi0mp#(vgo7l24_8uexx4l8-@#'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], #this tells django to look for templates in the templates folder at the root of the project.
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
