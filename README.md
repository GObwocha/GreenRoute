...
# Eco-Routing API Engine

The backend routing engine is currently live for the **Nairobi** area. 

## GET `/api/route/`
Calculates the most fuel-efficient route between two sets of coordinates using asymmetric topographical penalties.
...
**Example Request:**
`http://127.0.0.1:8000/api/route/?start_lat=-1.288&start_lng=36.785&end_lat=-1.295&end_lng=36.795`
